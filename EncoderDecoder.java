...
class Encrypt {
    ...
    public String getCorrespondingValue(String s, String k) {
        if (val.equals("Vigenere")) {
            ...
            if (enc)
                return vernamCipher(s, k);
            return vernamDecipher(s, k);
        } else {
            if (enc)
                return encryptCaesar(s, k);
...
public class Project {
    ...
    public static void main(String[] args) {
        ...
        ActionListener listener14 = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                encryptorOutputField
                        .setText(E.getCorrespondingValue(encryptorInputField.getText(), encryptorKeyField.getText()));
            }
        };
